...
if ($debug)
{
   print $DBG "perl ./dos_myget03.pl $clArgs  '$key'";
   if ($DBG){ close($DBG); }
   print "perl ./perl/dos_myget03.pl $clArgs  '$key'";
   ##exit;
}
...
#open($MYDATA, "perl ./dos_myget03.pl http://www.yahoo.com |") or print "Can't fork for myget01: $!\n";
# dos version begin
##open($MYDATA, "perl ./dos_myget03.pl $clArgs  $key |") or print "Can't fork for myget01: $!\n";
open($MYDATA, "perl ./perl/dos_myget03.pl $clArgs  $key |") or print "Can't fork for myget01: $!\n";

  # print "perl ./dos_myget03.pl $clArgs  '$key'";
...
print "<b>Thank you for using joemailweb.(2)</b>";
print "<hr></hr>";
print encode_entities($tag);
print "\n</MYMAIL>\n"
